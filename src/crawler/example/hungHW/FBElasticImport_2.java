 ...
 */
public class FBElasticImport_2 {

    static String elasticHost = "192.168.152.200" ;
    static String elasticPort = "9200" ;
    static String elasticIndex = "fb1";
    static String elasticIndexType = "data";
    static String pageName = "HuffingtonPost";
        ...
        for (long datatime = start ; datatime > start-86400*days ;datatime-=3600*8) {
            String uri =
                    "https://graph.facebook.com/v2.6"
                            ...
                            + "&access_token=436343800044620%7C69ab68e73e80cbd2394a2fea4b972f8f";
